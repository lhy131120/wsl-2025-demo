document.addEventListener("DOMContentLoaded", () => {
    ...
    tl.to(".logoWrap", { opacity: 1, duration: 1 })
      ...
      .to(".loader", {
        ...
        onComplete: () => {
          ...
          document
            .querySelectorAll(".headerTools button")
            .forEach((btn, index) => {
      ...
      .to(
        ".word-caption.top",
        { opacity: 1, duration: 2, left: "15%", ease: "ease.in" },
        "<"
      )
      .to(
        ".word-caption.botton",
        { opacity: 1, duration: 2, right: "20%", ease: "ease.in" },
        "<"
      )
      .to(
        ".typewriter",
        {
          ...
          onComplete: () => {
            document
              .querySelectorAll(".typewriter .word")
              .forEach((word, index) => {
  ...
  const sectionProjectAnimation = () => {
    ...
    let fullLength = () => {
      ...
      let containerR = document
        .querySelector(".projectWrap.horizontal")
  ...
  const sectionAboutAnimation = () => {
		// console.log("sectionAboutAnimation")
    ...
    const balls = gsap.utils.toArray(".ballArea .ball");
    console.log(balls);
    balls.forEach((ball) => {
      gsap.fromTo(
        ball,
  ...
  if (document.querySelector(".about")) sectionAboutAnimation();
